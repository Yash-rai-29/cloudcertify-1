...
import { FiCheck, FiChevronRight, FiArrowRight, FiStar, FiShield, FiCloud } from 'react-icons/fi';
  ...
  return (
    <section className="relative pt-24 pb-20 md:pt-36 md:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center" ref={ref}>
          ...
          >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="btn-pulse bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3.5 rounded-xl font-medium text-md shadow-lg transition-all"
              >
                Start For Free
              </motion.button>
              <motion.button
            ...
            >
              ...
              <div>
                ...
                <span>Join <b className="text-blue-600">7,800+</b> successful cloud professionals</span>
              </div>
            </motion.div>
          </motion.div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl overflow-hidden shadow-inner">
                    <div className="p-5">
                      ...
                      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-50">
                        <div className="text-sm font-medium mb-3 text-gray-700">Next Study Session</div>
                        <div className="flex flex-wrap justify-between items-center gap-3">
                          <div className="text-gray-800 font-medium">Implementation & Migration Module</div>
                          <motion.button
                            whileHover={{ scale: 1.05, boxShadow: "0 4px 12px rgba(59, 130, 246, 0.25)" }}
                            whileTap={{ scale: 0.95 }}
